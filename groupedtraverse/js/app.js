$( document ).ready(function() {
    ...
    animatelines('data/sensor_108_20150528.geojson', '#FF9933');
    animatelines('data/sensor_150_20150528.geojson', '#CC66FF');
    animatelines('data/sensor_151_20150528.geojson', '#2EB8E6');
    animatelines('data/sensor_205_20150528.geojson', '#E3D317');
    animatelines('data/sensor_1641_20150528.geojson', '#DE004B');
