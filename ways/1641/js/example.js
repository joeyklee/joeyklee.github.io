...
function init() {
    ...
    d3.json(ifile, function(data){
        ...
        {
            patterns: [
            { offset: 0, repeat: 10, symbol: L.Symbol.dash({pixelSize: 5, pathOptions: {color: waycolor, weight: 2, opacity: 1}}) },
            {offset: 25, repeat: 50, symbol: L.Symbol.arrowHead({pixelSize: 10, pathOptions: {fillOpacity: 0.75, weight: 0}})}
        ]
        }
    ).addTo(map);
